  ...
  var scope,
      ...
      ThreeSixty.prototype.initLoad = function() {
          ...
          for(i; i < len; i++){
              j = 0;
              for(j; j < data[i].count; j++){
                  url = data[i].path = 'https://fitment.chenyoujiu.com' + options.imgs[j].url
                  $('<img/>').data('index', i).attr('src', 'https://fitment.chenyoujiu.com' + options.imgs[j].url).load(this.onLoadComplete);
              }
          }
      };
      ...
      ThreeSixty.prototype.onLoadAllComplete = function(objIndex) {
          ...
          for(i; i < l; i++){
              ...
              html += '<img class="threesixty-frame" style="display:' + display + ';" data-index="' + i + '" src="' + 'https://fitment.chenyoujiu.com' + options.imgs[i].url + '"/>';
          }
          $this.html(html);
